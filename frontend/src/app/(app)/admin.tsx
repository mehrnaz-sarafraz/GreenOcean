      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.restricted}>
          ...
          <Text style={styles.pageSubtitle}>
            ...
            open trust and safety operations.
          </Text>
        ...
        <View style={styles.top}>
          ...
          <View style={styles.topText}>
            ...
            <Text style={styles.subtitle}>
              Trust, safety, and community operations
            </Text>
          </View>
  ...
  return (
    <>
      <View>
        ...
        <Text style={styles.pageSubtitle}>
          Live counts calculated from GreenOcean’s
          database.
        </Text>
      </View>
        ...
        >
          ...
          <View style={styles.flex}>
            ...
            <Text style={styles.alertText}>
              Open the queue and review the full
              context.
            </Text>
          </View>
...
function Reports({
  ...
  return (
    <>
      <Heading
        title="Reports queue"
        subtitle="User reports and automated safety signals."
      />
  ...
  return (
    <>
      <Heading
        ...
        subtitle="Review submitted identity, education, and license evidence."
      />

      {data.verificationQueue.map(
        item => (
          <View
            key={item.id}
            style={styles.card}
...
function Members({
  ...
  return (
    <>
      <Heading
        title="Members"
        subtitle="Current account status and moderation context."
      />
...
function Audit({
  ...
  return (
    <>
      <Heading
        title="Audit log"
        subtitle="Immutable moderation activity from the backend."
      />
