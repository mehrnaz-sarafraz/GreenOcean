...
export default function AppLayout() {
  ...
  return <Tabs screenOptions={{ headerShown: false, tabBarActiveTintColor: colors.ocean700, tabBarInactiveTintColor: colors.muted, tabBarLabelStyle: styles.label, tabBarStyle: styles.bar, tabBarItemStyle: styles.item }}>
    ...
    <Tabs.Screen name="notifications" options={{ href: null }} /><Tabs.Screen name="communities" options={{ href: null }} /><Tabs.Screen name="channels" options={{ href: null }} /><Tabs.Screen name="support" options={{ href: null, tabBarStyle: { display: 'none' } }} /><Tabs.Screen name="professionals" options={{ href: null }} /><Tabs.Screen name="safety-settings" options={{ href: null, tabBarStyle: { display: 'none' } }} /><Tabs.Screen name="edit-profile" options={{ href: null, tabBarStyle: { display: 'none' } }} /><Tabs.Screen name="articles" options={{ href: null }} /><Tabs.Screen name="media" options={{ href: null }} /><Tabs.Screen name="article-editor" options={{ href: null, tabBarStyle: { display: 'none' } }} /><Tabs.Screen name="article/[id]" options={{ href: null, tabBarStyle: { display: 'none' } }} /><Tabs.Screen name="admin" options={{ href: null, tabBarStyle: { display: 'none' } }} /><Tabs.Screen name="post/[id]" options={{ href: null }} /><Tabs.Screen name="community/[slug]" options={{ href: null }} /><Tabs.Screen name="chat/[id]" options={{ href: null, tabBarStyle: { display: 'none' } }} />
  </Tabs>;
}
